...
async function deleteTeam(){
  try{
    const response = await fetch(`${url}/admin/deleteTeam/${selectedTeam.id}`,{method:"DELETE"})
    if(response.ok){
      getTeams()
    }
  }catch(e){
        ...
        <View
          ...
          <View style={style.modalBody}>
            ...
            <View
              ...
              <MainBtn
                text="Cancel"
                style={{backgroundColor: Colors.grey,width:"auto",marginLeft:"auto",marginTop:20}}
